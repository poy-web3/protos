...
type GenerateTokenResponse struct {
	...
	TokenSignature string                  `protobuf:"bytes,3,opt,name=token_signature,json=tokenSignature,proto3" json:"token_signature,omitempty"`
}
...
func (x *GenerateTokenResponse) GetTokenSignature() string {
	if x != nil {
